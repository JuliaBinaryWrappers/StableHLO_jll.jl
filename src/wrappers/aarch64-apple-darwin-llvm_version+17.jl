# Autogenerated wrapper script for StableHLO_jll for aarch64-apple-darwin-llvm_version+17
export libStablehlo, stablehlo_lsp_server, stablehlo_opt, stablehlo_translate

using MLIR_jll
JLLWrappers.@generate_wrapper_header("StableHLO")
JLLWrappers.@declare_library_product(libStablehlo, "@rpath/libStablehlo.dylib")
